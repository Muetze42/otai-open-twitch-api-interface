    ...
    <body class="antialiased font-sans">
            ...
            <div class="w-full md:w-1/2 bg-white flex items-center justify-center">
                <div class="max-w-sm m-8">
                    ...
                    @if($__env->yieldContent('code') == 419)
                        <a href="{{ url()->current() }}" id="reload-btn">
        ...
        @if($__env->yieldContent('code') == 419)
            <script>
                ...
                if (!reloadBtn) {
                    console.log('Reload Button missing')
                } else {
                    let hrefSet = false
                    if (iframe[0]) {
                    ...
                    if (iframe && parent) {
                        let app = window.parent.document
                        if (app && app.location && app.location.href) {
                            reloadBtn.href = app.location.href
                            hrefSet = true
                        }
                    }
                    if (!hrefSet) {
